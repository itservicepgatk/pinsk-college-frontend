...
function getActionsBarHTML(type) {
    return `
        <div style="margin-bottom: 15px; display: flex; gap: 10px;">
            <button class="btn-danger btn-delete-selected" data-type="${type}" style="padding: 8px 16px;">Удалить выбранные</button>
            <button class="btn-danger btn-empty-trash" data-type="${type}" style="padding: 8px 16px; background-color: #c82333;">Очистить всё</button>
        </div>
    `;
}
